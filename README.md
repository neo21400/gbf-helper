...
* **Loot Tracker** — records raid drops automatically and shows them in a separate window (favorites, pinning, JSON export/import), and can backfill battles it missed — on mobile, say — from your own battle history.
